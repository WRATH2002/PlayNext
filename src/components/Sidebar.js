...
const Sidebar = () => {
  return (
    <>
      <div className="flex flex-row justify-start items-center w-[100%] whitespeace-nowrap overflow-hidden  px-[10px]  h-[40px] rounded-xl hover:bg-[#f3f3f3] cursor-pointer min-h-[40px] z-50">
        <Link to={"/"} className="flex justify-start items-center ">
          <RiHome3Line className="text-[20px]" />
          <span className="ml-[15px]  font-[roboto] font-normal text-[15px] ">
            Home
          </span>
        </Link>
      </div>
      ...
      <div className="flex flex-row justify-start items-center w-[100%] whitespeace-nowrap overflow-hidden   h-[20px] rounded-xl cursor-pointer min-h-[20px]">
        <div className="border-[.5px] border-[#f2f2f2] w-full"></div>
      </div>
      <div className="flex flex-row justify-start items-center w-[100%] whitespeace-nowrap overflow-hidden   px-[10px]  h-[40px] rounded-xl hover:bg-[#f3f3f3] cursor-pointer min-h-[40px]">
      ...
      {/* <div className="flex flex-row justify-start items-center w-[100%] whitespeace-nowrap overflow-hidden   px-[10px]  h-[40px] rounded-xl hover:bg-[#f3f3f3] cursor-pointer min-h-[40px]">
        ...
        <span className="ml-[15px]  font-[roboto] font-normal text-[15px] ">Gaming</span>
      </div> */}
      <div className="flex flex-row justify-start items-center w-[100%] whitespeace-nowrap overflow-hidden   px-[10px]  h-[40px] rounded-xl hover:bg-[#f3f3f3] cursor-pointer min-h-[40px]">
        <MdOutlineSportsBaseball className="text-[20px]" />
        <span className="ml-[15px] text-[14px] font-normal font-[roboto] ">
          Sport
        </span>
      </div>
    </>
