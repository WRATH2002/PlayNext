  ...
  return (
    <div className="w-full h-auto flex flex-col lg:flex-row md:flex-row">
      <div
        ...
        className="w-full md:w-[175px] lg:w-[175px] h-[98px] bg-[#f3f3f3] animate-pulse rounded-lg"
      ></div>
      <div className=" w-full md:w-[calc(100%-175px)]  lg:w-[calc(100%-175px)] pl-[10px] flex flex-col text-[#aaaaaa] font-[roboto]">
        <span className=" w-full min-h-[20px] rounded-sm max-h-[42px] text-15px  text-[14px] flex items-start justify-start overflow-hidden bg-[#f3f3f3] animate-pulse text-white line-clamp-2 text-ellipsis ">
          {/* {props.data.snippet.title} */}
        </span>
        <span className=" w-[70%] h-[15px] text-[12px] mt-[6px] rounded-sm bg-[#f3f3f3] animate-pulse">
          {/* Sony Live */}
        </span>
        {/* <div className="mt-[-3px]"> */}
        <span className=" w-[50%] h-[15px] text-[12px] bg-[#f3f3f3] animate-pulse mt-[6px] rounded-sm">
